...
export class GetBlockedDto {
  ...
  @IsPositive()
  @ApiProperty({
    description: 'userId of the user requesting to fetch a preview of all their blocked list',
    example: 1,
  })
...
export class GetBlockedResultDto {
  ...
  @ApiProperty({
    description: 'Conversation ID unionIdOther identifies the client12d user to a Chat that got blocked',
    example: 2,
  })
